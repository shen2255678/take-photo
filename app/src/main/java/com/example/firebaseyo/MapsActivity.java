...
//new
    ...
    public void onLocationChanged(Location location) {
        ...
        com.example.firebaseyo.Location mlocation =new com.example.firebaseyo.Location(location.getLongitude(),location.getLatitude());

        FirebaseDatabase.getInstance().getReference("Current location")
                .setValue(mlocation).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(MapsActivity.this,"Location is saved",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(MapsActivity.this,"Location no saved",Toast.LENGTH_SHORT).show();
                }
            }
        });
